...
import { CitationCard, type ReadPassageResult } from "@/components/citation-card";
...
export function ToolResult({ message }: { message: ToolMessage }) {
  ...
  // Custom rich rendering for read_passage tool — a CitationCard.
  if (message.name === "read_passage" && looksLikeReadPassage(parsedContent)) {
    return (
      <div className="mx-auto grid max-w-3xl grid-rows-[1fr_auto] gap-2">
        <CitationCard data={parsedContent} />
      </div>
    );
  }
